        ...
        <>
        	<div class="content-container grey-bg block-container">
	            <div class="container">
	                <div class="row">
	                    <div class="col-lg-12">
	                        <ul class="home-block-list block-list mobile-slider d-md-flex flex-md-wrap flex-md-row-reverse">
	                            <li class="block-item">
	                                <div class="block-box d-flex flex-column">
	                                    ...
	                                    <div class="block-btn"><Link to="/what-we-get" class="btn btn-primary">FIND OUT MORE</Link></div>
	                                </div>
	                            </li>
	                            <li class="block-item">
	                                <div class="block-box d-flex flex-column">
